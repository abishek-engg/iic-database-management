  ...
  return (
    <div className="bg-[#EEEEEE] ml-[200px] w-[calc(100vw-250px)] h-[calc(100vh-60px)] mt-[60px] py-[20px] flex flex-col items-center">
      <div className="w-full mb-[30px] pl-[60px]">
        <span>
          Event {">"} Self Driven {">"} Create Event
        </span>
      </div>
        ...
        <div className="h-max pl-0 pr-5 py-4">
          <form>
            <div className="bg-white mb-[10px] rounded-[10px]">
              ...
              <div className="p-4 h-[80px] border-b flex flex-row items-center">
                <label for="eventTheme" className="w-[400px] inline-block">
                  Event Theme
                </label>
                <input
                  required
              ...
              <div className="p-4 min-h-[80px] border-b flex flex-row items-center">
                <label for="objective" className="w-[400px] inline-block">
                  Objective
                </label>
                <textarea
                  required
                  ...
                  id="objective"
                  value=""
                  className="w-[600px] bg-[#EEEEEE] h-[40px] rounded-[5px] pl-4 pt-2 focus:ring-[#76ABAE] focus:ring-1 focus:outline-none"
                />
              </div>
              <div className="p-4 min-h-[80px] border-b flex flex-row items-center">
                <label for="outcome" className="w-[400px] inline-block">
                  Outcome
                </label>
                <textarea
                  required
