...
function Home() {
  return (
    <div className="bg-[#EEEEEE] ml-[200px] w-[calc(100vw-250px)] h-[calc(100vh-60px)] py-[20px] mt-[60px] flex flex-col items-center ">
      ...
      <div className="w-11/12 h-[200px] grid grid-flow-col grid-col-2 justify-start">
        <div className="flex flex-row h-[150px] w-[400px] items-center bg-[#31363F] rounded-lg mr-[50px]">
          <div className="p-4">
            <FaUser
